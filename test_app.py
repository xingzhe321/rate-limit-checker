...
class AppTests(unittest.TestCase):
    def test_granted_at_is_used_for_issued_time(self):
        ...
        with patch.object(app, "read_token", return_value="x"), patch.object(app.urllib.request, "urlopen", return_value=FakeResponse(payload)):
    ...
    def test_missing_credits_is_reported(self):
        with patch.object(app, "read_token", return_value="x"), patch.object(app.urllib.request, "urlopen", return_value=FakeResponse({"available_count": 0})):
